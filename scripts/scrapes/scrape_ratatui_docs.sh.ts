...
const DEFAULT_OUTPUT_DIR_RELATIVE = "docs/external/ratatui";
const CONCURRENCY = 4;
...
for (const artifact of artifacts) {
  await Bun.write(
    ...
    buildSnapshotPageMarkdown(artifact, capturedAt, {
      ...
      summaryFallback: "Ratatui documentation page snapshot.",
...
await Bun.write(
  ...
  buildSnapshotIndexMarkdown(artifacts, capturedAt, {
    ...
    indexSummary: "This index links one `.ext.md` file per docs page snapshot for Ratatui.",
    notes: [
