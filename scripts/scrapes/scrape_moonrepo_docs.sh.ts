...
for (const artifact of artifacts) {
  await Bun.write(
    ...
    buildSnapshotPageMarkdown(artifact, capturedAt, {
      ...
      baseKeywords: "moonrepo, docs, monorepo, task runner, toolchain",
      summaryFallback: "Moonrepo documentation page snapshot.",
      collectionMethodNote: "sitemap-first discovery scoped to moonrepo docs.",
...
await Bun.write(
  ...
  buildSnapshotIndexMarkdown(artifacts, capturedAt, {
    ...
    indexKeywords: "moonrepo, docs index, monorepo, task runner, toolchain",
    indexSummary: "This index links one `.ext.md` file per docs page snapshot for moonrepo docs.",
    notes: [
