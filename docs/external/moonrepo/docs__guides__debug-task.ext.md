...
- Keywords: moonrepo, docs, monorepo, task runner, toolchain, guides, debug task
...
- [Home](/)
- [Debugging a task](/docs/guides/debug-task)
...
### Verify inherited configuration[​](#verify-inherited-configuration)
...
## Inspect trace logs[​](#inspect-trace-logs)
...
## Inspect the hash manifest[​](#inspect-the-hash-manifest)
...
### Diffing a previous hash[​](#diffing-a-previous-hash)
...
[Edit this page](https://github.com/moonrepo/moon/tree/master/website/docs/guides/debug-task.mdx)
