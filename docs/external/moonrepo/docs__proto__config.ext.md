...
- Keywords: moonrepo, docs, monorepo, task runner, toolchain, proto, config
...
- [Home](/)
- [Configuration](/docs/proto/config)
...
## Resolution modev0.40.0[​](#resolution-mode)
...
### `upwards-global` / `all`[​](#upwards-global--all)
...
## Environment modev0.29.0[​](#environment-mode)
...
### Lock `proto` versionv0.39.0[​](#lock-proto-version)
...
#### `builtin-plugins`v0.39.0[​](#builtin-plugins)
...
#### `cache-duration`v0.50.1[​](#cache-duration)
...
#### `detect-strategy`[​](#detect-strategy)
...
#### `unstable-lockfile`v0.51.0[​](#unstable-lockfile)
...
#### `unstable-registries`v0.51.0[​](#unstable-registries)
...
#### `url-rewrites`v0.50.0[​](#url-rewrites)
...
### `[settings.build]`v0.46.0[​](#settingsbuild)
...
#### `allow-invalid-certs`[​](#allow-invalid-certs)
...
#### `secure-proxies`v0.40.3[​](#secure-proxies)
...
### `[settings.offline]`v0.41.0[​](#settingsoffline)
...
#### `override-default-hosts`[​](#override-default-hosts)
...
### `[plugins.backends]`v0.52.0[​](#pluginsbackends)
...
### `[backends.*.env]`v0.53.0[​](#backendsenv)
...
### `[plugins.tools]`v0.52.0[​](#pluginstools)
...
[Edit this page](https://github.com/moonrepo/moon/tree/master/website/docs/proto/config.mdx)
