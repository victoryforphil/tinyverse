...
- Summary: [Skip to content](http://opencode.ai/docs/keybinds#_top)
----
...
Keybinds | OpenCode
===============
[Skip to content](http://opencode.ai/docs/keybinds#_top)
...
*   [Overview](http://opencode.ai/docs/keybinds#_top)
*   [Leader key](http://opencode.ai/docs/keybinds#leader-key)
*   [Disable keybind](http://opencode.ai/docs/keybinds#disable-keybind)
*   [Desktop prompt shortcuts](http://opencode.ai/docs/keybinds#desktop-prompt-shortcuts)
*   [Shift+Enter](http://opencode.ai/docs/keybinds#shiftenter)
    *   [Windows Terminal](http://opencode.ai/docs/keybinds#windows-terminal)
...
[Edit page](https://github.com/anomalyco/opencode/edit/dev/packages/web/src/content/docs/keybinds.mdx)[Found a bug? Open an issue](https://github.com/anomalyco/opencode/issues/new)[Join our Discord community](https://opencode.ai/discord)Select language 
