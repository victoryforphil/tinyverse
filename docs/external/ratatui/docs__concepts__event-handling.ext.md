...
- Source page: /concepts/event-handling
- Keywords: ratatui, rust, tui, terminal ui, docs, concepts, event handling
- Summary: There are many ways to handle events with the `ratatui` library. Mostly because `ratatui` does not
----
...
Cons: However, this particular way of handling events simply does not scale well. Because all
...
way could lead to a lot of duplicated code.
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/concepts/event-handling.md)

 [Previous Layout](/concepts/layout/) [Next Builder Lite Pattern](/concepts/builder-lite-pattern/)
